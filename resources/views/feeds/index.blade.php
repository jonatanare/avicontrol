    ...
    <div class="container">
        <div class="row mb-4">
            <div class="col-12">
                <div class="row">
                    <div class="col-6">
                        <a href="{{ route('feeds.adjust', ['adjustment_type' => 'add']) }}" class="btn btn-success">
                    ...
                    <div class="col-6 text-right">
                        <a href="{{ route('feeds.adjust', ['adjustment_type' => 'subtract']) }}" class="btn btn-info">
                            <div class="d-flex align-items-center">
                                <img
                    ...
                    <tbody>
                        @foreach ($feeds as $feed)
                            <tr>
                                ...
                                <td>
                                    <span
                                        class="p-1 {{ $feed->addition_range === 'notSpecified' ? 'badge badge-info' : 'badge badge-success' }}">
